...
export default function App() {
  ...
  return <div className="min-h-screen bg-slate-100 p-4 md:p-8 font-sans">
    ...
    <div className="max-w-4xl mx-auto overflow-auto"><div ref={documentRef} className="bg-white p-10 shadow-xl border border-slate-200 text-slate-900 mx-auto" style={{ width: '210mm', minHeight: '297mm' }}>
      ...
      <div className="grid grid-cols-2 gap-6 mb-6 text-sm bg-slate-50 p-4 rounded-lg border border-slate-200"><p><b>{t.partner}</b><br />{partnerName}</p><p><b>{t.client}</b><br />{clientName}</p><p><b>{t.issuer}</b><br />Terratransport SA</p><p><b>{t.website}</b><br />www.terratransport-sa.com</p></div>
