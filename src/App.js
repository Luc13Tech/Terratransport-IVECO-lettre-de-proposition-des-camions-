...
export default function App() {
  ...
  return <div className="min-h-screen bg-slate-100 p-4 md:p-8 font-sans">
    ...
    <div className="max-w-4xl mx-auto overflow-auto"><div ref={documentRef} className="bg-white p-10 shadow-xl border border-slate-200 text-slate-900 mx-auto" style={{ width: '210mm', minHeight: '297mm' }}>
      <div className="flex justify-between items-start border-b-2 border-blue-900 pb-6 mb-6"><div><img src="/logo.png" alt="Logo Terratransport" className="h-16 object-contain mb-2" /><p className="text-xs text-slate-500">Terratransport SA</p></div><div className="text-right text-xs"><p><b>{t.ref}</b> {docNumber}</p><p><b>{t.date}</b> {docDate}</p></div></div>
